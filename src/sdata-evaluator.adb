...
with SData.Evaluator.Nav_Fns;        pragma Warnings (Off, SData.Evaluator.Nav_Fns);
with SData.Evaluator.Distrib_Fns;    pragma Warnings (Off, SData.Evaluator.Distrib_Fns);
with SData.Evaluator.Misc_Fns;       pragma Warnings (Off, SData.Evaluator.Misc_Fns);
