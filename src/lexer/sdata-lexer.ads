...
package SData.Lexer is
   ...
   type Token_Kind is (
      ...
      Token_REPEAT, Token_DO, Token_UNTIL, Token_SELECT, Token_CASE, Token_WHEN, Token_OTHERWISE, Token_SUBMIT,
      Token_LET, Token_SET, Token_UNSET, Token_DIM, Token_ARRAY, Token_SYSTEM,
      Token_PRINT, Token_NOTE, Token_WRITE, Token_OUTPUT, Token_ECHO,
      Token_BY, Token_SORT, Token_RENAME, Token_DELETE, Token_REMOVE, Token_RSEED, Token_NOT, Token_AND, Token_OR, Token_XOR,
