   ...
   type Statement (Kind : Statement_Kind) is record
      ...
      case Kind is
         when Stmt_PRINT | Stmt_NOTE =>
            ...
            --  ADR-081 (Bywater BASIC): character I is ';' when a semicolon
            --  follows argument I -- that argument is printed with nothing
            --  after it -- and a space otherwise (a comma or plain
            --  whitespace).  Kept here rather than on Expression_List_Node
            --  because that type belongs to sdata-core.
            Print_Seps : Ada.Strings.Unbounded.Unbounded_String;
            --  The statement ends in a semicolon: no newline after it.
            Print_Trailing_Semi : Boolean := False;
