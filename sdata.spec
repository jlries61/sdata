...
* Wed Sep 16 2026 John L. Ries <john@theyarnbard.com> - 0.32.0-1
- TABLES output reformatted to match STATS's column-aligned, ruled style (ADR-076)
...
* Fri Sep 04 2026 John L. Ries <john@theyarnbard.com> - 0.23.1-1
- Fix #76: unknown-function/arity checking now reaches RSEED/NOTE/DIM/SAVE's IF=, matching PRINT (ADR-062)
...
* Mon Aug 03 2026 John L. Ries <john@theyarnbard.com> - 0.16.8-1
- Add REPL integration test coverage via a Makefile .repl marker convention (issue #69, ADR-053).
...
* Thu Jul 30 2026 John L. Ries <john@theyarnbard.com> - 0.16.5-1
- Validate SORT/BY variable names unconditionally, not gated on Column_Count > 0 (issue #67)

* Thu Jul 30 2026 John L. Ries <john@theyarnbard.com> - 0.16.4-1
- Reject SORT/AGGREGATE/TRANSPOSE/STATS inside an active REPEAT block (issue #66)
...
* Mon Jul 13 2026 John L. Ries <john@theyarnbard.com> - 0.14.3-1
- Fix doubled-quote string escape dropping characters in the lexer (#52)

* Mon Jul 13 2026 John L. Ries <john@theyarnbard.com> - 0.14.2-1
- Allow assigning a missing value to an existing typed column (#51)
