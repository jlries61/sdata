...
- **data-vandal** — a standalone interpreter for controlled data degradation
  ...
  v0.9.6). See [ADR-038](doc/adrs.md) (now superseded) and the data-vandal
...
```sh
scripts/bump-version.sh 0.9.6 "Fix path resolution in FPATH SUBMIT handler."
```
...
```
$ sdata
SData Statistical Interpreter version 0.9.6
