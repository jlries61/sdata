...
| Integration `.cmd` | **592** |
| `csv_unit_test` | 71 |
| `sdata_unit_test` (Table/Variables/PDV/transient/merge) | 384 |
...
EAV disk-spill schema (jlries61/sdata#64). CI runs all unit suites + 592
...
61 ADRs (ADR-001…061), 27 design specs, 36 implementation plans. ADRs 039–043
