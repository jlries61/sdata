...
| ~~1 unit test module~~ 5 unit test modules (~~433~~ 436 unit tests + 131 integration = 567 total) | `tests/csv_unit_test.adb`, `tests/sdata_unit_test.adb`, `tests/file_io_unit_test.adb`, `tests/evaluator_unit_test.adb`, `tests/interpreter_unit_test.adb` | All major subsystems have unit coverage |
