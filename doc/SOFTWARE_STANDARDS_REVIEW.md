...
| Integration `.cmd` | **407** |
| `csv_unit_test` | 71 |
| `sdata_unit_test` (Table/Variables/PDV/transient/merge) | 375 |
...
EAV disk-spill schema (jlries61/sdata#64). CI runs all unit suites + 407
integration tests + a fuzz-corpus regression on push and PR. data-vandal
carries its own 148 integration tests (run manually / its own CI); sdata-core
...
57 ADRs (ADR-001…057), 27 design specs, 36 implementation plans. ADRs 039–043
