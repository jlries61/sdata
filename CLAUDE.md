...
- `doc/` (singular) — existing committed documentation (man page, ADR spreadsheet,
  design specs, standards review). **Use this for new committed docs.**
- `docs/` — SSD scaffold for ADRs/runbooks generated by SSD skills. If you generate
  an ADR via `/ssd feature`, put it under `doc/` to stay consistent with the project.
