...
AGGREGATE, SUBMIT, BREAK, etc.). Build sdata-core too if you touch it: `cd ~/Develop/sdata-core && alr build`.
...
| Immediate | RUN, SORT, AGGREGATE, NEW, NAMES, SYSTEM, HELP | Execute immediately; not purely declarative |
